// @vovelet/vcore mock implementation
// This module handles Z-Score calculations and Let reward generation

/**
 * Calculate Z-Score based on Vove evaluation score
