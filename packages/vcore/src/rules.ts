import { Z_SCORE_THRESHOLDS, Z_SCORE_LEVELS, SERVICES, SERVICE_TYPES, ZScoreLevel, ServiceType } from '@vovelet/shared';
...
export function getAvailableServices(zScoreLevel: ZScoreLevel): ServiceType[] {
  ...
  switch (zScoreLevel) {
    ...
    case Z_SCORE_LEVELS.BASIC:
      availableServices.push(SERVICE_TYPES.VOVE_PREMIUM);
      break;
    default:
      break;
  }
